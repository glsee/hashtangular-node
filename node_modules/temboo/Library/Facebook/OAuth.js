...
var InitializeOAuthInputSet = function() {
    InitializeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Scope input for this Choreo. ((optional, string) A comma-separated list of permissions to request access for (i.e. "publish_actions,read_mailbox"). For more information see documentation.)
        */
