...
var FriendRequestsResultSet = function(resultStream) {
    FriendRequestsResultSet.super_.call(this, resultStream);
        ...
        */
        this.get_UnreadCount = function() {
            return this.getResult("UnreadCount");
        }
}
...
var GetLatestPrivateMessage = function(session) {
    /*
        Create a new instance of the GetLatestPrivateMessage Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Reading/GetLatestPrivateMessage"
    GetLatestPrivateMessage.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new GetLatestPrivateMessageResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new GetLatestPrivateMessageInputSet();
    }
...
var GetLatestPrivateMessageInputSet = function() {
    GetLatestPrivateMessageInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var GetLatestPrivateMessageResultSet = function(resultStream) {
    GetLatestPrivateMessageResultSet.super_.call(this, resultStream);
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Facebook. Corresponds to the ResponseFormat input. Defaults to JSON.)
        */
        this.get_Response = function() {
        ...
        */
        this.get_CreatedTime = function() {
            return this.getResult("CreatedTime");
        }
        /*
        ...
        */
        this.get_FromName = function() {
            return this.getResult("FromName");
        }
        /*
...
util.inherits(GetLatestPrivateMessage, choreography.Choreography);
util.inherits(GetLatestPrivateMessageInputSet, choreography.InputSet);
util.inherits(GetLatestPrivateMessageResultSet, choreography.ResultSet);
exports.GetLatestPrivateMessage = GetLatestPrivateMessage;
...
/*
    Notifications
    Retrieves unread Facebook notifications for a user.
*/


var Notifications = function(session) {
    /*
        Create a new instance of the Notifications Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Reading/Notifications"
    Notifications.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new NotificationsResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new NotificationsInputSet();
    }
...
/*
An InputSet with methods appropriate for specifying the inputs to the Notifications
Choreo. The InputSet object is used to specify input parameters when executing this Choreo.
*/

var NotificationsInputSet = function() {
    NotificationsInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
        ...
        */
        ...
        /*
        Set the value of the ProfileID input for this Choreo. ((optional, string) The id of the profile to retrieve notifications for. Defaults to "me" indicating the authenticated user.)
        */
        this.set_ProfileID = function(value) {
            this.setInput("ProfileID", value);
        }
...
var NotificationsResultSet = function(resultStream) {
    NotificationsResultSet.super_.call(this, resultStream);
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Facebook. Corresponds to the ResponseFormat input. Defaults to JSON.)
        */
        this.get_Response = function() {
...
util.inherits(Notifications, choreography.Choreography);
util.inherits(NotificationsInputSet, choreography.InputSet);
util.inherits(NotificationsResultSet, choreography.ResultSet);
