...
var GetBloodPressureResultSet = function(resultStream) {
    GetBloodPressureResultSet.super_.call(this, resultStream);
        ...
        */
        ...
        /*
        Retrieve the value for the "AverageDiastolic" output from this Choreo execution. ((integer) The average diastolic metric for the specified date.)
        */
        this.get_AverageDiastolic = function() {
            return this.getResult("AverageDiastolic");
        }
        /*
        Retrieve the value for the "AverageSystolic" output from this Choreo execution. ((integer) The average systolic metric for the specified date.)
        */
        this.get_AverageSystolic = function() {
            return this.getResult("AverageSystolic");
        }
        /*
        Retrieve the value for the "Condition" output from this Choreo execution. ((string) The condition name.)
        */
