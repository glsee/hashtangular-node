...
var GetHeartRateResultSet = function(resultStream) {
    GetHeartRateResultSet.super_.call(this, resultStream);
        ...
        */
        this.get_ExertiveHeartRate = function() {
            return this.getResult("ExertiveHeartRate");
        }
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Fitbit.)
        */
        ...
        */
        this.get_NormalHeartRate = function() {
            return this.getResult("NormalHeartRate");
        }
        /*
        ...
        */
        this.get_RestingHeartRate = function() {
            return this.getResult("RestingHeartRate");
        }
}
