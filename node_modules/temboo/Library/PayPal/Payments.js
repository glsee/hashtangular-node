...
var GetLatestPayment = function(session) {
    /*
        Create a new instance of the GetLatestPayment Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/PayPal/Payments/GetLatestPayment"
    GetLatestPayment.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new GetLatestPaymentResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new GetLatestPaymentInputSet();
    }
...
var GetLatestPaymentInputSet = function() {
    GetLatestPaymentInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((optional, string) A valid access token retrieved from PayPal. Required unless providing the ClientID and ClientSecret which can be used to generate a new access token.)
        */
        this.set_AccessToken = function(value) {
...
var GetLatestPaymentResultSet = function(resultStream) {
    GetLatestPaymentResultSet.super_.call(this, resultStream);
        /*
        Retrieve the value for the "Response" output from this Choreo execution. ((json) The response from PayPal.)
        */
        this.get_Response = function() {
        ...
        */
        this.get_CreateTime = function() {
            return this.getResult("CreateTime");
        }
        /*
        Retrieve the value for the "NewAccessToken" output from this Choreo execution. ((string) The new access token retrieved from PayPal when providing the Client ID and Client Secret.)
        */
...
util.inherits(GetLatestPayment, choreography.Choreography);
util.inherits(GetLatestPaymentInputSet, choreography.InputSet);
util.inherits(GetLatestPaymentResultSet, choreography.ResultSet);
