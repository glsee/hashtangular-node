...
var ParameterizedQuery = function(session) {
    /*
        Create a new instance of the ParameterizedQuery Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/PostgreSQL/ParameterizedQuery"
    ParameterizedQuery.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new ParameterizedQueryResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new ParameterizedQueryInputSet();
    }
...
var ParameterizedQueryInputSet = function() {
    ParameterizedQueryInputSet.super_.call(this);
        /*
        Set the value of the DatabaseName input for this Choreo. ((required, string) The name of the database to connect to.)
        */
        this.set_DatabaseName = function(value) {
...
var ParameterizedQueryResultSet = function(resultStream) {
    ParameterizedQueryResultSet.super_.call(this, resultStream);
        /*
...
util.inherits(ParameterizedQuery, choreography.Choreography);
util.inherits(ParameterizedQueryInputSet, choreography.InputSet);
util.inherits(ParameterizedQueryResultSet, choreography.ResultSet);
