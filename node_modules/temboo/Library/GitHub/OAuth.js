...
var InitializeOAuthInputSet = function() {
    InitializeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Scope input for this Choreo. ((optional, string) A comma separated list of scopes to associate with the access token. See description for more information. Ex.: user,repo,public_repo.)
        */
