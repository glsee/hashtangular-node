...
var RetrievePropertyValue = function(session) {
    /*
        Create a new instance of the RetrievePropertyValue Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Parse/Objects/RetrievePropertyValue"
    RetrievePropertyValue.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new RetrievePropertyValueResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new RetrievePropertyValueInputSet();
    }
...
var RetrievePropertyValueInputSet = function() {
    RetrievePropertyValueInputSet.super_.call(this);
        /*
        Set the value of the ApplicationID input for this Choreo. ((required, string) The Application ID provided by Parse.)
        */
        this.set_ApplicationID = function(value) {
...
var RetrievePropertyValueResultSet = function(resultStream) {
    RetrievePropertyValueResultSet.super_.call(this, resultStream);
        /*
...
util.inherits(RetrievePropertyValue, choreography.Choreography);
util.inherits(RetrievePropertyValueInputSet, choreography.InputSet);
util.inherits(RetrievePropertyValueResultSet, choreography.ResultSet);
exports.RetrievePropertyValue = RetrievePropertyValue;
