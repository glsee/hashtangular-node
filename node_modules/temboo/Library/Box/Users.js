...
var GetAllUsers = function(session) {
    /*
        Create a new instance of the GetAllUsers Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Box/Users/GetAllUsers"
    GetAllUsers.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new GetAllUsersResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new GetAllUsersInputSet();
    }
...
var GetAllUsersInputSet = function() {
    GetAllUsersInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved during the OAuth2 process.)
        */
        this.set_AccessToken = function(value) {
        ...
        */
        this.set_FilterTerm = function(value) {
            this.setInput("FilterTerm", value);
        }
...
var GetAllUsersResultSet = function(resultStream) {
    GetAllUsersResultSet.super_.call(this, resultStream);
        /*
        Retrieve the value for the "Response" output from this Choreo execution. ((json) The response from Box.)
        */
        this.get_Response = function() {
...
util.inherits(GetAllUsers, choreography.Choreography);
util.inherits(GetAllUsersInputSet, choreography.InputSet);
util.inherits(GetAllUsersResultSet, choreography.ResultSet);
