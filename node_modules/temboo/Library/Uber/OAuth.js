...
var FinalizeOAuth = function(session) {
	...
	*/
    var location = "/Library/Uber/OAuth/FinalizeOAuth"
...
var FinalizeOAuthInputSet = function() {
    FinalizeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the ClientID input for this Choreo. ((required, string) The Client ID provided by Uber after registering your application.)
        */
        ...
        /*
        Set the value of the ClientSecret input for this Choreo. ((required, string) The Client Secret provided by Uber after registering your application.)
        */
...
var InitializeOAuth = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Uber/OAuth/InitializeOAuth"
...
var InitializeOAuthInputSet = function() {
    InitializeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Scope input for this Choreo. ((optional, string) A space-delimited list of scopes to requests access for. See Choreo notes for a list of valid scopes.)
        */
...
var RefreshToken = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Uber/OAuth/RefreshToken"
...
var RefreshTokenResultSet = function(resultStream) {
    RefreshTokenResultSet.super_.call(this, resultStream);
        ...
        */
        ...
        /*
        Retrieve the value for the "Scope" output from this Choreo execution. ((string) The scope associated with the new Access Token.)
        */
        this.get_Scope = function() {
            return this.getResult("Scope");
        }
}
