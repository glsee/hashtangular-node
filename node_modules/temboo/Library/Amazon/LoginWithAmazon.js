...
var FinalizeOAuth = function(session) {
	...
	*/
    var location = "/Library/Amazon/LoginWithAmazon/FinalizeOAuth"
...
var FinalizeOAuthInputSet = function() {
    FinalizeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the ClientID input for this Choreo. ((required, string) The Client ID provided by Amazon.)
        */
        ...
        /*
        Set the value of the ClientSecret input for this Choreo. ((required, string) The Client Secret provided by Amazon.)
        */
...
var FinalizeOAuthResultSet = function(resultStream) {
    FinalizeOAuthResultSet.super_.call(this, resultStream);
        ...
        */
        ...
        /*
        Retrieve the value for the "ErrorMessage" output from this Choreo execution. ((string) If an error occurs during the redirect process, this output variable will contain the error message generated by Amazon.)
        */
...
var InitializeOAuth = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Amazon/LoginWithAmazon/InitializeOAuth"
...
var InitializeOAuthInputSet = function() {
    InitializeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Scope input for this Choreo. ((conditional, string) A space-delimited list of permissions to request access for (e.g., clouddrive:read clouddrive:write).)
        */
