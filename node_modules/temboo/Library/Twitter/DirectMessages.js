...
var GetLatestDirectMessage = function(session) {
    /*
        Create a new instance of the GetLatestDirectMessage Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Twitter/DirectMessages/GetLatestDirectMessage"
    GetLatestDirectMessage.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new GetLatestDirectMessageResultSet(resultStream);
    }
...
var GetLatestDirectMessageInputSet = function() {
    GetLatestDirectMessageInputSet.super_.call(this);
        /*
        Set the value of the AccessTokenSecret input for this Choreo. ((required, string) The Access Token Secret provided by Twitter or retrieved during the OAuth process.)
        */
        this.set_AccessTokenSecret = function(value) {
...
var GetLatestDirectMessageResultSet = function(resultStream) {
    GetLatestDirectMessageResultSet.super_.call(this, resultStream);
        /*
        Retrieve the value for the "Response" output from this Choreo execution. ((json) The response from Twitter.)
        */
        this.get_Response = function() {
        ...
        */
        this.get_RecipientScreenName = function() {
            return this.getResult("RecipientScreenName");
        }
        /*
        Retrieve the value for the "Remaining" output from this Choreo execution. ((integer) The number of requests left for the 15 minute window.)
        */
        ...
        */
        this.get_SenderScreenName = function() {
            return this.getResult("SenderScreenName");
        }
        /*
...
util.inherits(GetLatestDirectMessage, choreography.Choreography);
util.inherits(GetLatestDirectMessageInputSet, choreography.InputSet);
util.inherits(GetLatestDirectMessageResultSet, choreography.ResultSet);
exports.GetLatestDirectMessage = GetLatestDirectMessage;
