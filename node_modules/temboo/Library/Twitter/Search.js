...
var LatestTweet = function(session) {
    /*
        Create a new instance of the LatestTweet Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Twitter/Search/LatestTweet"
    LatestTweet.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new LatestTweetResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new LatestTweetInputSet();
    }
...
var LatestTweetInputSet = function() {
    LatestTweetInputSet.super_.call(this);
        /*
...
var LatestTweetResultSet = function(resultStream) {
    LatestTweetResultSet.super_.call(this, resultStream);
        /*
...
util.inherits(LatestTweet, choreography.Choreography);
util.inherits(LatestTweetInputSet, choreography.InputSet);
util.inherits(LatestTweetResultSet, choreography.ResultSet);
exports.LatestTweet = LatestTweet;
